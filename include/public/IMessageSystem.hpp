...
namespace SPMod
{
    ...
    {
    public:
        virtual std::size_t registerHook(int msgType, MessageHandler handler, std::any cbData, bool post) = 0;
        virtual void unregisterHook(int msgType, std::size_t index) = 0;
