...
SPGlobal::SPGlobal(fs::path &&dllDir)
    : m_SPModDir(dllDir.parent_path().parent_path()), m_forwardManager(std::make_unique<ForwardMngr>()),
      ...
      m_messageManager(std::make_unique<MessageMngr>()), m_nativeProxy(std::make_unique<NativeProxy>()),
      m_engineFuncs(std::make_unique<EngineFuncs>()), m_engineFuncsHooked(std::make_unique<EngineFuncsHooked>()),
      m_engineGlobals(std::make_unique<EngineGlobals>()), m_utils(std::make_unique<Utils>()),
